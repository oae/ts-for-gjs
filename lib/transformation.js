...
exports.Transformation = exports.RESERVED_NAMESPACE_NAMES = exports.RESERVED_FUNCTION_NAMES = exports.RESERVED_CLASS_NAMES = exports.RESERVED_VARIABLE_NAMES = exports.FULL_TYPE_MAP = exports.C_TYPE_MAP = exports.POD_TYPE_MAP = exports.POD_TYPE_MAP_ARRAY = void 0;
const path_1 = __importDefault(require("path"));
const utils_1 = require("./utils");
const logger_1 = require("./logger");
const POD_TYPE_MAP_ARRAY = (environment) => {
    return {
        guint8: environment === 'gjs' ? 'Uint8Array' : 'any',
        // Int8Array would probably be more appropriate for gint8, but Uint8Array is better supported
        gint8: environment === 'gjs' ? 'Uint8Array' : 'any',
        gunichar: 'string',
    };
};
exports.POD_TYPE_MAP_ARRAY = POD_TYPE_MAP_ARRAY;
...
const C_TYPE_MAP = (targetFullName, suffix = '') => {
    return {
        'char*': 'string',
        'gchar*': 'string',
        'gchar**': 'any',
...
const FULL_TYPE_MAP = (environment, out = true) => {
    let ba;
    let gb;
    if (environment === 'gjs') {
        ba = 'Uint8Array';
...
exports.FULL_TYPE_MAP = FULL_TYPE_MAP;
