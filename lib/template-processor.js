...
const eslint_1 = require("eslint"); // TODO depricated: https://eslint.org/docs/developer-guide/nodejs-api#cliengine
const lint = new eslint_1.CLIEngine({ ignore: false, fix: true, useEslintrc: true });
